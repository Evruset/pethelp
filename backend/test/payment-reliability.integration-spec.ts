...
async function createExpiredPaymentFixture(database: DatabaseService, service: PaymentService) {
  ...
  await database.query(`INSERT INTO clinic_schema.clinic_services (id, clinic_location_id, code, display_name, duration_minutes) VALUES ($1::uuid, $2::uuid, 'RELIABILITY_TEST', 'Reliability test', 30)`, [serviceId, locationId]);
