...
const { CapabilityEvaluatorService } = require('../src/auth/capability-evaluator.service') as typeof import('../src/auth/capability-evaluator.service');
...
const { featureFlags } = require('../src/config/feature-flags.config') as typeof import('../src/config/feature-flags.config');
...
type DatabaseService = DatabaseServiceType;
