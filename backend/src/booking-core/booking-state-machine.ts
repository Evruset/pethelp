...
const transitions: Record<HoldState, readonly HoldState[]> = {
  ...
  RELEASED: [],
  SLA_BREACHED: [],
  MIS_RESERVATION_PENDING: ['MIS_HELD', 'MIS_RECONCILIATION_PENDING', 'MIS_BOOKING_FAILED', 'RELEASED'],
  MIS_RECONCILIATION_PENDING: ['MIS_HELD', 'MIS_BOOKING_FAILED', 'RELEASED'],
