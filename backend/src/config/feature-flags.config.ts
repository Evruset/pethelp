...
export const featureFlags = Object.freeze({
  ...
  DOCTOR_SHIFT_INVENTORY_V1: readBooleanFlag('DOCTOR_SHIFT_INVENTORY_V1', false),
  OWNER_R2E_SPECIALIST_PROJECTION: readBooleanFlag('OWNER_R2E_SPECIALIST_PROJECTION', false),
