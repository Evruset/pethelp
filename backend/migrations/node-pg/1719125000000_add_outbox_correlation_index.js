...
exports.up = (pgm) => {
  pgm.sql(`
    ...
    CREATE INDEX IF NOT EXISTS telemed_sessions_correlation_idx
      ON telemed_schema.telemed_sessions (correlation_id)
      WHERE correlation_id IS NOT NULL;
...
exports.down = (pgm) => {
  pgm.sql(`
    ...
    DROP INDEX IF EXISTS telemed_schema.telemed_sessions_correlation_idx;
    ALTER TABLE telemed_schema.telemed_sessions DROP COLUMN IF EXISTS correlation_id;
  `);
};
