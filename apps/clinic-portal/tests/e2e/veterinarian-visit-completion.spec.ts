...
function visit() { return { holdId, clinicId, locationId, scheduledStart: '2026-07-12T10:00:00.000Z', scheduledEnd: '2026-07-12T10:30:00.000Z', status, petDisplayName: 'Milo', species: 'CAT', visitId: status === 'COMPLETED' ? visitId : null }; }
