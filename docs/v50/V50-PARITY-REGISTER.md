...
All rows below are anchored to the verified V50 source and common manifest SHA-256 `245e092941dcd11f590423e9c8d54929fe7b6adfa2abcb6c2168fd56ba79ff42`. Evidence package `v50-owner-04-985dd5b` passed independent validation with zero vetoes; visual fidelity is `9/30 VISUALLY_VERIFIED`.
...
| OWN-006 | `prototype-v50/manifest.json#sha256` | Owner / Booking review | `#booking-review` → `/owner/booking/review` | recoverable review route from flagged selection page | public browse; OWNER pet required only after auth handoff | selected typed context revalidated through booking-options | none; continuation stops before hold | ready/stale/request-only/offline; back retains selection; auth restore | 375/412/768/1440 captured | `OWNER_V50_BOOKING_REVIEW`, default off after parent flags | Flutter PASS; 16 runtime captures; independent PASS | REPLACE | IMPLEMENTED / TESTED / VISUALLY_VERIFIED; honest price/confirmation and no-success-before-mutation wording |
