...
|---|---|---|---|---|---|---|---|---|
| ROOT | V51 Program Coordinator | Program | `main` | ACTIVE | Parity governance and integration | `docs/ai/current-state.md` | `a36a332` | none |
| CLINIC-AUTHORITY-01 | Remove clinical completion from admin schedule | Clinic/Veterinarian boundary | `agent/v51-stage-55-authority-orchestration` | ACTIVE | Stage 5.5 authority hardening | `docs/ai/handoffs/CLINIC-AUTHORITY-01.md` | `2cec646` | CI pending |
| OWNER-01 | Owner shell, home, pets and Pet Diary | Owner | not created | PLANNED | OWNER-HOME, PETS, PROFILE, DIARY | — | — | current gate not reached |
...
| CLINIC-02 | Schedule, staff, resources and quality | Clinic | integrated in `main` | READY_FOR_INTEGRATION | SCHEDULE, QUALITY | `docs/ai/current-state.md` | `a36a332` | clinical action removal in progress |
| VET-01 | Visit workspace and clinical completion | Veterinarian | integrated in `main` | COMPLETE | VET VISIT LIST/DETAIL/COMPLETE | `docs/ai/current-state.md` | `a36a332` | none |
