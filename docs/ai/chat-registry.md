...
|---|---|---|---|---|---|---|---|---|
| ROOT | V50 Program Coordinator | Program | `agent/v51-stage-01-architecture` / root worktree | ACTIVE | V50-OWNER-03 ready for integration; V50-OWNER-04 inactive | `docs/ai/current-state.md` | `d55b292` | protected `.codex` changes remain untouched |
