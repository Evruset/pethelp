...
|---|---|---|---|---|---|---|---|---|
| ROOT | V50 Program Coordinator | Program | `agent/v51-stage-01-architecture` / root worktree | ACTIVE | V50-OWNER-04 integrated; V50-OWNER-05 next | `docs/ai/current-state.md` | merge `9e165a3` | protected `.codex` changes remain untouched |
