...
|---|---|---|---|---|---|---|---|---|
| ROOT | V50 Program Coordinator | Program | `agent/v51-stage-01-architecture` / root worktree | ACTIVE | V50-OWNER-03 bootstrap coordination | `docs/ai/current-state.md` | `78d9322` | protected `.codex` changes remain untouched |
...
| V50-OWNER-03 | V50 Clinic Catalog and Doctor Discovery | Owner | `agent/v50-owner-03` / `/Users/evrusetskiy/work/pethelp-alpha-v50-owner-03` | ACTIVE / NOT_READY | `OWN-002`, `OWN-004`, `OWN-018`, `OWN-019` | `docs/ai/handoffs/V50-OWNER-03.md` | base `d55b292` | public/optional-owner boundary architecture review in progress |
