...
(() => {
  ...
  const doctors = {
    anna: { id: 'anna', name: 'Анна Смирнова', speciality: 'THERAPIST', label: 'Терапевт', experience: '8 лет', photo: 'assets/images/doctor-anna.webp' },
    igor: { id: 'igor', name: 'Игорь Лебедев', speciality: 'SURGEON', label: 'Хирург', experience: '12 лет', photo: 'assets/images/doctor-igor.webp' },
    katya: { id: 'katya', name: 'Екатерина Волкова', speciality: 'DERMATOLOGIST', label: 'Дерматолог', experience: '7 лет', photo: 'assets/images/doctor-katya.webp' },
    dmitry: { id: 'dmitry', name: 'Дмитрий Орлов', speciality: 'CARDIOLOGIST', label: 'Кардиолог', experience: '10 лет', photo: 'assets/images/doctor-dmitry.webp' },
  };
