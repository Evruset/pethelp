...
(() => {
    ...
    patients: [
      {
        ...
        avatar:'assets/images/pet-barney.webp', owner:'Екатерина Романова', phone:'+7 000 000-00-00', email:'demo@example.invalid',
      ...
      },
      {
        ...
        avatar:'assets/images/pet-murka.webp', owner:'Игорь Петров', phone:'+7 000 000-00-00', email:'demo@example.invalid',
      ...
      },
      {
        ...
        avatar:'assets/images/pet-lucky.webp', owner:'Мария Соколова', phone:'+7 000 000-00-00', email:'demo@example.invalid',
      ...
      },
      {
        ...
        avatar:'assets/images/pet-murka.webp', owner:'Ольга Власова', phone:'+7 000 000-00-00', email:'demo@example.invalid',
      ...
      },
      {
        ...
        avatar:'assets/images/pet-lucky.webp', owner:'Алексей Миронов', phone:'+7 000 000-00-00', email:'demo@example.invalid',
  ...
  const icon = (name) => `<img src="assets/icons/${assets[name]}" alt="" aria-hidden="true" draggable="false"/>`;
  ...
  function staffChip() {
    ...
    return `<div class="v48-staff-chip" aria-label="Текущий сотрудник">
      <img src="assets/images/${doctor ? 'doctor-anna.webp' : 'clinic-reception.webp'}" alt=""/>
  ...
  function bindEvents() {
    ...
    document.addEventListener('submit', (event) => {
      ...
      if (form.id === 'v48-patient-form') {
        ...
        state.patients.push({ id,name:data.get('name'),species:data.get('species'),breed:data.get('breed') || 'Не указана',sex:'Не указан',birth:'Не указана',age:data.get('age') || 'Не указан',weight:'Не указан',avatar:'assets/images/pet-lucky.webp',owner:data.get('owner'),phone:data.get('phone'),email:'Не указан',allergies:String(data.get('allergies') || '').split(',').map((item) => item.trim()).filter(Boolean),conditions:[],policy:'Полиса нет',lastVisit:'—',documents:0,balance:'0 ₽',records:[] }); state.selectedPatient = id; addAudit(`Создана карточка пациента ${data.get('name')}`, 'Светлана Котова · ресепшен'); closeDialog(); commit('Карточка пациента создана.'); return;
      }
